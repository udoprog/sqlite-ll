...
//! [<img alt="build status" src="https://img.shields.io/github/actions/workflow/status/udoprog/sqlite-ll/ci.yml?branch=main&style=for-the-badge" height="20">](https://github.com/udoprog/sqlite-ll/actions?query=branch%3Amain)
//!
